...
const usuario1 = new Usuario('miUsuario', 'Juan', 'juan@example.com', 'contraseña123');
...
function agregarMetodoPrototype(Usuario) {
  ...
  // Definimos la función constructora Usuario
  function Usuario2(nombre) {
    this.nombre = nombre;
  }
  
  agregarMetodoPrototype(Usuario2);
  
  var usuario2 = new Usuario("John");
...
function agregarStringInvertida() {
  ...
  // Llamamos a la función para agregar el método reverse al prototipo de String
  agregarStringInvertida();
  
  // Usamos el método reverse en una cadena
